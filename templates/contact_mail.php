                                            ...
                                            <table width="100%" align="center" cellspacing="0" cellpadding="20"
												...
												background-color: #fff; overflow: hidden;border-bottom: 1px solid #E2E2E2;">
                                                        <img style="width: 180px; margin-top:20px;margin-bottom:20px;"
                                                            alt=""
                                                            src="https://techsport-global.com/templates/logo.png">
                                                    </td>
                                            ...
                                            <table width="100%" align="center" cellspacing="0" cellpadding="20"
                                                ...
                                                <tr>
													...
													font-family: 'Product sans bold;line-height: 1.5;">
                                                        <h1
                                                            style="text-align:left; font-weight:700; font-size:20px;color: #333;font-family: 'Product sans bold', sans-serif;">
                                                            <span style="font-weight:500;">Message from
                                                                {{f_name}}</span>
                                                        </h1>

                                                        <p class="mobile-p" align="left"
                                                            style="font-weight: 400; margin-top:20px !important;
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="mobile-p mob-td" align="left"
                                                                    ...
                                                                    <ul class="f-list">
                                                                        <li>
                                                                            <a href="https://uk.trustpilot.com/evaluate/techsport-global.com"
                                                                                target="_blank"
                                                                                style="margin-right:5px;">
                                                                                <img src="https://techsport-global.com/templates/trustpilot.png"
                                                                                    alt="trust pilot">
                                                                            </a>
                                                                            <p class="mobile-p" align="left"
                                                                ...
                                                                <td class="mobile-p mob-td" align="right"
                                                                    ...
                                                                    <a href="https://twitter.com/TechSportGlobal"
                                                                        ...
                                                                        <img src="https://techsport-global.com/templates/twitter.png"
                                                                            alt="twitter" style="width:40px;">
                                                                    </a>
                                                                    <a href="https://www.instagram.com/techsportglobal/"
                                                                        target="_blank" style="margin-right:5px;">
                                                                        <img src="https://techsport-global.com/templates/insta.png"
                                                                            alt="instagram" style="width:40px;">
                                                                    </a>
                                                                    <a href=" https://g.page/r/CUqQRCmsCY1ZEBM/review"
                                                                        target="_blank" style="margin-right:5px;">
                                                                        <img src="https://techsport-global.com/templates/google.png"
                                                                            alt="instagram" style="width:40px;">
                                                                    </a>
                                                            ...
                                                            <tr>
                                                                <td class="mobile-p mob-td" align="left"
                                                                    ...
                                                                    <a style="color: blue"
                                                                        href="https://techsport-global.com">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" class="mobile-p mob-td" align="left"
                                                                    ...
                                                                    <p class="mobile-p" align="left"
                                                                        ...
                                                                        hello@techsport-group.com. The messaging system
                                                                        from which this e-mail was sent is checked
                                                                        regularly for viruses. No liability is accepted
                                                                        for any viruses which may be transmitted in or
                                                                        with this e-mail from Tech Sport Group.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
